...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, apply_proj: bool = False):
        ...
        if self.proj is not None and apply_proj:
            x = x @ self.proj
...
class CLIP(nn.Module):
    ...
    def encode_image(self, image):
        input = image - self.image_mean.expand_as(image)
        input = input / self.image_std.expand_as(image)
        return self.visual(input, apply_proj=False)
